    ...
    AllocaInst(Type* base_type,
        ...
        : Instruction(vALLOCA,
                      ir::Type::pointer_type(
                          ir::Type::array_type(base_type, dims, capacity)),
                      parent,
                      name),
          _is_const(is_const) {}
...
class BinaryInst : public Instruction {
   ...
   public:
    ...
    bool iscommutative() {
        auto inst = this;
        return inst->scid() == vADD || inst->scid() == vFADD ||
               inst->scid() == vMUL || inst->scid() == vFMUL;
    }
...
class ICmpInst : public Instruction {
   ...
   public:
    bool isReverse(ICmpInst* y) {
        auto x = this;
        if ((x->scid() == vISGE && y->scid() == vISLE) ||
            (x->scid() == vISLE && y->scid() == vISGE)) {
            return true;
        } else if ((x->scid() == vISGT && y->scid() == vISLT) ||
                   (x->scid() == vISLT && y->scid() == vISGT)) {
            return true;
        } else if ((x->scid() == vFOGE && y->scid() == vFOLE) ||
                   (x->scid() == vFOLE && y->scid() == vFOGE)) {
            return true;
        } else if ((x->scid() == vFOGT && y->scid() == vFOLT) ||
                   (x->scid() == vFOLT && y->scid() == vFOGT)) {
            return true;
        } else {
            return false;
        }
