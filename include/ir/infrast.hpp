...
class Argument : public Value {
  ...
  public:
    Argument(Type* type, size_t index, Function* parent = nullptr, const_str_ref name = "") : Value(type, vARGUMENT, name), mIndex(index), mFunction(parent) {}
...
class BasicBlock : public Value {
  ...
  public:
    BasicBlock(const_str_ref name = "", Function* parent = nullptr) : Value(Type::TypeLabel(), vBASIC_BLOCK, name), mFunction(parent) {};
...
class Instruction : public User {
  ...
  public:
    ...
    Instruction(ValueId itype = vINSTRUCTION, Type* ret_type = Type::void_type(), BasicBlock* pblock = nullptr, const_str_ref name = "")
